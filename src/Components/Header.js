        ...
        <div className="col-lg-8 col-xl-7 col-xxl-6">
          <div className="my-5 text-center text-xl-start">
            ...
            <p className="lead fw-normal text-black-50 mb-4">
              ...
              dolorum ut aut?Lorem ipsum dolor sit amet consectetur adipisicing
              elit. Saepe repellendus ipsa, est fuga nisi magni sequi, officia
              consectetur quibusdam atque quis et facilis repellat minima,
              ratione veniam dolorum ut aut?
            </p>
